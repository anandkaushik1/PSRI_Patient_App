...
class DoctorList_Only_screen extends StatefulWidget {

  final String? DeptId;

  DoctorList_Only_screen({
    this.DeptId,
...
class _CardListScreenState extends State<DoctorList_Only_screen> {
                ...
                return AnimationConfiguration.staggeredList(
                  ...
                  child: SlideAnimation(
                    ...
                    child: FadeInAnimation(
                      child: DoctorCardSpecial(  MediaQuery.of(context).size.width, 56.0, res.getDoctorListArrayy!.elementAt(index),
                         index,
                      ),
                    ),
                  ),
