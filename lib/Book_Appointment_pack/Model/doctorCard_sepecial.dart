...
class DoctorCardSpecial extends StatefulWidget {
   double? width;
   double? height;
   GetDoctorListArrayy? doctorList;
   int? pos;
   DoctorCardSpecial(this.height,this.width,this.doctorList,this.pos);

  @override
  _DoctorCardSpecialState createState() => _DoctorCardSpecialState(this.height,this.width,this.doctorList,this.pos);
}

class _DoctorCardSpecialState extends State<DoctorCardSpecial> {
  double? width;
  double? height;
  GetDoctorListArrayy? doctorList;
  int? pos;
