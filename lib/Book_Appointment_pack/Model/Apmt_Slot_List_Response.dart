class Apmt_Slot_List_Response {
  List<DoctorAppAppointmentSchedule>? doctorAppAppointmentSchedule;
  String? status;
  String? msg;

  Apmt_Slot_List_Response({this.doctorAppAppointmentSchedule, this.status, this.msg});

  Apmt_Slot_List_Response.fromJson(Map<String, dynamic> json) {
