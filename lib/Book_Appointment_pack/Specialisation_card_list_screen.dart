...
ListofSpecialisationResponse res = new ListofSpecialisationResponse();

String tempTypeOfSearch = "";
String doctorId="", facilityId="", hospitalId="";

class Specialisation_card_list_screen extends StatefulWidget {
  Specialisation_card_list_screen({
    Key? key,
  }) : super(key: key);
...
class _CardListScreenState extends State<Specialisation_card_list_screen> {
  ...
  Widget callBackApiResponse() {
    return FutureBuilder<ListofSpecialisationResponse>(
      future: callApi(), // function where you call your api
      builder: (BuildContext context,
          AsyncSnapshot<ListofSpecialisationResponse> data) {
...
Future<ListofSpecialisationResponse> callApi() async {
  String url = BasicUrl.sendUrl();
  final myService = MyServicePost.create(url);
  ListofSpecialisationRequest objddd = new ListofSpecialisationRequest();
  objddd.str = "";
  ListofSpecialisationRequest objj =
      new ListofSpecialisationRequest.fromJson(objddd.toJson());
  Response<ListofSpecialisationResponse> responserrr =
      (await myService.MobSpecialisationList(objj));
  var postt = responserrr.body;
  print(responserrr.body);
  res = new ListofSpecialisationResponse.fromJson(postt!.toJson());
