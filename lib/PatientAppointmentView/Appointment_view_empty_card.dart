...
class Appointment_view_empty_card extends StatelessWidget {
  final double? width;
  final double? height;
  final AppointmentListJSon? patientDetails;
  final int? pos;

  const Appointment_view_empty_card({
    Key? key,
    this.width,
    this.height,
    this.patientDetails,
          ...
          children: [
            new Column(
              ...
              children: <Widget>[
                ...
                new Text(
                  "Appointment Id:- " + patientDetails!.appointmentId.toString(),
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14,
                  ),
                ...
                new Text(
                  "Patient Name:- " + patientDetails!.patientName.toString(),
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14,
                  ),
                ...
                new Text(
                  "Date/Time:- " + patientDetails!.appointmentDate.toString()+" "+patientDetails!.fromTime.toString(),
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14,
                  ),
                ...
                new Text(
                  "Payment Status:- " + patientDetails!.paymentStatus.toString(),
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14,
                  ),
