...
import 'AddMemberOTPRequest.dart';
...
class _UnRegistrationState
  ...
  void initState() {
    ...
    ctrMobile.text = CommonStrAndKey.galobsharedPrefs!.getString(CommonStrAndKey.mobileNo) ??
        '';
  }
  @override
  void dispose() {
...
/*  Widget customRadioButton()
  ...
  Future requestForOtp(String strMobile) async {
    ...
    AddMemberOTPRequest setObj=new AddMemberOTPRequest();
    setObj.mobileNo=""+strMobile;
    setObj.isFamilyMember=true;
    print("Request  \n" + setObj.toJson().toString());
    AddMemberOTPRequest obj=new AddMemberOTPRequest.fromJson(setObj.toJson());
    Response<AddMemberOTPResponse> response = (await myService.GenerateOTPForFamily(obj));
    print(response.body);
    var post = response.body;

    AddMemberResponse res= new AddMemberResponse.fromJson(response.body!.toJson());
    print("Response   \n"+res.toJson().toString());
  ...
  Future forRegistration(String strOTP) async {
    ...
    String url=BasicUrl.sendUrl();
    final myService = MyServicePost.create(url);
    AddMemberRequest setObj=new AddMemberRequest();
    ...
    setObj.oTP=""+strOTP;
    print("Request  \n" + setObj.toJson().toString());
    AddMemberRequest obj=new AddMemberRequest.fromJson(setObj.toJson());
    Response<AddMemberResponse> response = (await myService.MobSaveRegistrationForFamily(obj));
    print(response.body);
    var post = response.body;
    AddMemberResponse res= new AddMemberResponse.fromJson(post!.toJson());
    ...
    if(response!=null)
    {
      if(response.body!.status!.toString().toLowerCase()=="success")
      {
        ...
        /*Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Multi_Patient_list_screen(
  ...
  PatientList setPatientDetails( AddMemberResponse details)
  {
