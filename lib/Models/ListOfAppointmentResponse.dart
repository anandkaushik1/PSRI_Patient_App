...
class ListOfAppointmentResponse {
  List<DoctorAppAppointmentSchedule>? doctorAppAppointmentSchedule;
  String?  status;
  String?  msg;

  ListOfAppointmentResponse({this.doctorAppAppointmentSchedule, this.status, this.msg});

  ListOfAppointmentResponse.fromJson(Map<String, dynamic> json) {
