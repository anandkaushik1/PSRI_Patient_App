...
import 'package:flutter_patient_app/RescheduleAppointment/RescheduleEmptyCard.dart';
...
class RescheduleAppointment_Slot extends StatefulWidget {
  ...
  final DateTime? globelDate;
  final AppointmentListJSon? myAppointData;

  RescheduleAppointment_Slot({
    this.doctorId,
    this.nameDoctor,
    this.strFacitily,
    this.strHospital,
...
class _NestedTabBarState extends State<RescheduleAppointment_Slot>
  ...
  _NestedTabBarState(
      {this.doctorId, this.nameDoctor, this.strFacitily,
        this.strHospital,this.globelDate,this.myAppointData,
  ...
  Future<TeleAppmt_Slot_Response> callApiAppointment(String StrDectorId,DateTime date) async {
    ...
    objddd.facilityID = int.parse(strFacitily!.toString());
