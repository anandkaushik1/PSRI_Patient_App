...
/*  Widget selectedchart(Vital_Graph_Response fieldListData)
  {
    ...
    {
      return new charts.BarChart(_createS(fieldListData), animate: false,
        barRendererDecorator: new charts.BarLabelDecorator<String>(),
        domainAxis: new charts.OrdinalAxisSpec(),
      );
     }else
    {
      return  new charts.LineChart(_createSampleDataLine(fieldListData!), animate: false) ;
 ...
 /* static List<charts.Series<OrdinalSales, DateTime>> _createSampleData(Lab_Garph_View_Response dataObj) {
    ...
    var data=  new List<OrdinalSales>(dataObj.resultGraphList!.length);
...
*/
 /* static List<charts.Series<LinearSales, DateTime>> _createSampleDataLine(Vital_Graph_Response dataObj) {
    ...
    LinearSales field;
    var data= <LinearSales>(dataObj.vitalGraphList!.length);
...
*/
 /* static List<charts.Series<OrdinalSalesMy, String>> _createS(Vital_Graph_Response? dataObj) {
    OrdinalSalesMy? field;
    var data=  <OrdinalSalesMy>(dataObj!.vitalGraphList!.length);
    for(int i=0;i<dataObj!.vitalGraphList!.length;i++)
    {
      var value=double.parse(dataObj!.vitalGraphList!.elementAt(i).vitalValue.toString());
      int intvalue=value.round();
...
*/
  ...
  Future<Vital_Graph_Response>  callApi(String regIdStr)  async {
      ...
      obj.vitalId=""+CommonStrAndKey.selectedPatient;
