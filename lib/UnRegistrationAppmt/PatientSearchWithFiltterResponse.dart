class PatientSearchWithFiltterResponse {
  List<PatientDetailsArray>? patientDetailsArray;
  String? status;
  String? msg;

  PatientSearchWithFiltterResponse(
      {this.patientDetailsArray, this.status, this.msg});

  PatientSearchWithFiltterResponse.fromJson(Map<String, dynamic> json) {
