...
class _NestedTabBarStateee extends State<LabReport> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<LabVisitResponse>(
      ...
      builder: (BuildContext context, AsyncSnapshot<LabVisitResponse> data) {
            ...
            children: _allPages.map<Widget>((_Page page) {
              return Container(
                child: Center(
                  child: Lab_Card_List(
                    encounterNo:
                        res.visitHistory!.elementAt(page.pos!.toInt()).encounterNo,
  ...
  Future<LabVisitResponse> callApi(String r) async {
    ...
    Response<LabVisitResponse> responserrr =
        (await myService.GetInvestigationVisit(objj));
