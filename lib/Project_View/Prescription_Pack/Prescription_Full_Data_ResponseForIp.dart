class Prescription_Full_Data_ResponseForIp {
  List<CashesheetSummary>? cashesheetSummary;
  String? status;

  Prescription_Full_Data_ResponseForIp({this.cashesheetSummary, this.status});

  Prescription_Full_Data_ResponseForIp.fromJson(Map<String, dynamic> json) {
    if (json['CashesheetSummary'] != null) {
...
class Section {
  ...
  Section({this.sectionId, this.sectionName, this.field});
