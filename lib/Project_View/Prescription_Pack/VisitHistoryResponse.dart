class VisitHistoryResponse {
  ...
  VisitHistoryResponse({this.visitHistory, this.status, this.msg});

  VisitHistoryResponse.fromJson(Map<String, dynamic> json) {
